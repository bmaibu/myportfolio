...
// const navLinks = document.querySelectorAll('#navbar a'); // FIXED SELECTOR
...
//     // Your scroll handling code here (already handled above)
//     ticking = false;
// }
...
//     window.location.href = `mailto:maibu@example.com?subject=${subject}&body=${body}`;
